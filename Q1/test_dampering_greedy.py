...
from bandits.greedy_tempering import DampedEpsilonGreedyAgent
...
if __name__ == '__main__':
    ...
    plt.ion()
    plt.plot(percentage_correct_actions[0], color='red', label='e = 0.5')
    plt.plot(percentage_correct_actions[1], color='green', label='e = 0.7')
    plt.plot(percentage_correct_actions[2], color='blue', label='e = 0.9')
    ...
    plt.ion()
    plt.plot(regret[0], color='red', label='e = 0.5')
    plt.plot(regret[1], color='green', label='e = 0.7')
    plt.plot(regret[2], color='blue', label='e = 0.9')
