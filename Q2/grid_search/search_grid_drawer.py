        ...
        for i in range(width):
            for j in range(height):
                ...
                if (cell in self._parent_arrows):
                    parentArrow = self._parent_arrows[cell]
                ...
                parentArrow = Line(Point((cell_coords[0] + 0.5)* self._cell_size, \
                ...
                parentArrow.setOutline('red')
                self._parent_arrows[cell] = parentArrow
                parentArrow.draw(self._win)                
